...
@Repository
public class Staff004Repository {
    /**
     * 従業員情報詳細 Mapper
     */
    @Autowired
 ...
 * @return 検索結果
 */
public List<StaffInfo> searchStaffs(Staff003InputDto staff003InputDto) {
    ...
    List<Staff> staffs = staffMapper.searchStaffs(staffSearch);
    if (staffs.size()>0){
